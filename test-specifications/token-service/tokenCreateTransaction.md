...
| treasuryAccountId       | string                                           | optional          | The ID of the account which will act as the treasury and will received the specified initial supply of the new token.                                                                                                                             |
...
| supplyType              | string                                           | optional          | The supply of the new token. MUST be one of `infinite` or `finite`                                                                                                                                                                                |
