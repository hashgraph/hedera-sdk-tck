...
| 2       | Creates an account with a max token association set to 100                         | key=<VALID_KEY>, maxAutoTokenAssociations=100  | The account creation succeeds and the account has 0 automatic token associations.                                                | N                 |
