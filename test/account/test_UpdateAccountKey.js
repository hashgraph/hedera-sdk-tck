...
describe("#updateAccountKey()", function () {
  ...
  it("should create a third key set", async function () {
  ...
  it("should retrieve first public key of newly created account", async function () {
    ...
    expect(JSON.stringify(firstKeySet)).to.equal(JSON.stringify(PublicKey.fromString(firstPublicKey)));
  });
  ...
  it("verify that key set updated", async function () {
    ...
    expect(JSON.stringify(updatedPublicKey)).to.equal(JSON.stringify(PublicKey.fromString(newPublicKey)));
  });
